<template>
  <div class="relative">
    ...
    <button
      class="flex items-center justify-center w-[224px] h-[59px] m-auto mt-0 text-white rounded-[32px] bg-[#061836B2] border border-[rgba(238, 232, 169, 1)] text-2xl"
    >
    ...
    <div
      ...
      class="w-[80%] absolute left-[10%] top-[-20px] flex items-center justify-between h-10 opacity-0 transform -translate-y-20 transition-all duration-1000"
    >
      <!-- متن لوگو -->
